...
const navItems = [
  { 
    section: 'Main',
    items: [
      { name: '🏙️ Market Trends', path: '/trends', description: 'Dubai rental market insights' },
      { name: '📊 My Portfolio', path: '/portfolio', description: 'Manage your properties' },
      { name: '🧠 Advisor', path: '/advisor', description: 'Smart investment suggestions' },
      { name: '🎯 Goals', path: '/goals', description: 'Set your investment targets' },
    ]
  },
  {
    section: 'Analytics',
    items: [
      { name: '📈 Performance', path: '/performance', description: 'Portfolio performance metrics' },
      { name: '🔍 Market Research', path: '/research', description: 'Deep market analysis' },
      { name: '📑 Reports', path: '/reports', description: 'Generated insights' },
    ]
  },
  {
    section: 'Account',
    items: [
      { name: '⚙️ Settings', path: '/settings', description: 'Customize your experience' },
      { name: '📱 Notifications', path: '/notifications', description: 'Manage alerts' },
...
function NavItem({ name, path, description }) {
